                            ...
                            @if(count($categories)>0)
                                ...
                                @foreach($categories as $category)
                                    <tr>
                                        ...
                                        <td><img src="{{asset('/images/category/'.$category->image)}}" alt="not available" height="100" width="100"></td>
                                        <td id="action">
                                            <span><a href="{{ route('category.edit', $category->id) }}" class="fa fa-edit" title="Click Here To Edit"></a></span>
                                            <span><a href="#" class="fa fa-trash deleteRecord" alert="Are you sure you want to delete Mandate" title="Click Here To Delete"></a>
                                                <form action="{{ route('category.destroy', $category->id)}}" method="post" style="display:none">
                                                    @csrf
                                                    @method('delete')
